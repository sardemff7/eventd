...
static void
_test_new_null(gpointer fixture, gconstpointer user_data)
{
    if (g_test_trap_fork (0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR))
    {
        eventd_event_new(NULL);
        exit(0);
    }
...
static void
_test_set_id_notnull_good(gpointer fixture, gconstpointer user_data)
{
    SettersData *data = fixture;
...
static void
_test_set_id_null_good(gpointer fixture, gconstpointer user_data)
{
    if (g_test_trap_fork (0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR))
    {
        eventd_event_set_id(NULL, EVENTD_EVENT_TEST_ID);
        exit(0);
    }
    g_test_trap_assert_failed();
}
...
static void
_test_set_id_notnull_bad(gpointer fixture, gconstpointer user_data)
{
    SettersData *data = fixture;

    if (g_test_trap_fork (0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR))
    {
        eventd_event_set_id(data->event, NULL);
        exit(0);
    }
    g_test_trap_assert_failed();
}
...
static void
_test_set_category_null_good(gpointer fixture, gconstpointer user_data)
{
    if (g_test_trap_fork (0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR))
    {
        eventd_event_set_category(NULL, EVENTD_EVENT_TEST_CATEGORY);
        exit(0);
    }
    g_test_trap_assert_failed();
}
...
static void
_test_set_category_notnull_bad(gpointer fixture, gconstpointer user_data)
{
    SettersData *data = fixture;

    if (g_test_trap_fork (0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR))
    {
        eventd_event_set_category(data->event, NULL);
        exit(0);
    }
    g_test_trap_assert_failed();
}
