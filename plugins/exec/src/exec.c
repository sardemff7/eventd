...
{
    interface->init   = _eventd_exec_init;
    interface->uninit = _eventd_exec_uninit;

    interface->event_parse  = _eventd_exec_event_parse;
    interface->config_reset = _eventd_exec_config_reset;

    interface->event_action = _eventd_exec_event_action;
}
