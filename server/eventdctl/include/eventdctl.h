...
typedef enum {
    ...
    EVENTDCTL_RETURN_CODE_CONNECTION_ERROR     = 1,
    EVENTDCTL_RETURN_CODE_INVOCATION_ERROR     = 2,
    EVENTDCTL_RETURN_CODE_COMMAND_ERROR        = 10,
    EVENTDCTL_RETURN_CODE_PLUGIN_ERROR         = 11,
