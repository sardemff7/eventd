...
typedef enum {
    ...
    EVENTCTL_RETURN_CODE_PLUGIN_COMMAND_ERROR = EVENTD_PLUGIN_COMMAND_STATUS_COMMAND_ERROR,
    EVENTCTL_RETURN_CODE_PLUGIN_EXEC_ERROR    = EVENTD_PLUGIN_COMMAND_STATUS_EXEC_ERROR,
} EventdctlReturnCode;
